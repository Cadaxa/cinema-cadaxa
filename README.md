...
git clone https://github.com/judocadaxa/cinema-cadaxa "$env:USERPROFILE\.claude\skills\cinema-cadaxa"
```

### macOS / Linux

```bash
git clone https://github.com/judocadaxa/cinema-cadaxa ~/.claude/skills/cinema-cadaxa
```
...
Criado por [Judo Cadaxa](https://github.com/judocadaxa).
